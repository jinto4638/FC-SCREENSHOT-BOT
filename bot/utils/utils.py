...
async def screenshot_fn(c, m):
    ...
    try:
        ...
        await edit_message_text(m, text='Just s sec bro..!! 🙇🏻  identifying the file........😇')
...
async def sample_fn(c, m):
    ...
    try:
        ...
        await edit_message_text(m, text='⌛️  Processing the sample! This might take some time.')
...
async def trim_fn(c, m):
    ...
    snt = await m.reply_text(' ⏳⌛️ Processing your request, Please wait! 😴', True)
    ...
    try:
        ...
        await snt.edit_text('✂️  Trimming Your Video! This might take some time.')
