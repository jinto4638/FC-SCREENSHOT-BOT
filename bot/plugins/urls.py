...
async def _(c, m):
    ...
    snt = await m.reply_text("Just s sec bro..!! 🙇🏻  identifying the file........😇", quote=True)

    duration = await get_duration(m.text)
    if isinstance(duration, str):
        await snt.edit_text("☹️ Sorry dude! I cannot open the file.")
